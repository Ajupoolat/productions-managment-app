...
export default function ProductionLocationsPage() {
  ...
  return (
    <div className="glass-panel p-8 rounded-2xl border border-slate-800/60 min-h-[400px] flex flex-col items-center justify-center text-center space-y-4">
      ...
      <h2 className="text-2xl font-bold text-white">Locations Requests</h2>
      <p className="text-slate-400 max-w-md">
        Request and manage filming locations for <strong>{production.name}</strong>. This feature is coming soon!
      </p>
    </div>
  );
}
